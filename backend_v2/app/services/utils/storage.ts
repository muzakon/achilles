...
export class GoogleCloudStorageService {
   ...
   */
  constructor(bucketName: string, serviceAccountData: object, raiseExceptions: boolean = true) {
   ...
   */
  async uploadImageFromUrl(imageUrl: string, destinationFileName: string): Promise<void> {
    try {
