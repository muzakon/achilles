...
export class Fal extends RequestManager {
  ...
  async checkStatus(requestId: string, model: string): Promise<QueuedImageTaskResponse> {
  ...
  async fetchResult(requestId: string, model: string): Promise<ProcessedImageTaskResponse> {
